...
- [Project scope](project-scope.md) — current implementation boundaries and
  design constraints.
- [FYP milestones](milestones.md) — authoritative academic schedule and
  near-term delivery focus.
- [Master notes](master-notes.md) — living evidence bank for the report and
  oral presentation.
...
- [Oral presentation preparation](oral-presentation.md) — presentation
  narrative, Q&A bank, demo checklist, and rehearsal log.
